...
%
% ATTENTION: This script is depricated and cannot be supported anymore! Please use OESDiscrete.m!
%%%
function OESDiscrete(trainTime, randomizationSeed)

sprintf('ATTENTION: This script is depricated and cannot be supported anymore!\nPlease use instead OESDiscrete.m!')
return;
