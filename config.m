...
alpha_n = 0.01;                      %learning rate of natural policy gradient | origin 0.05 | Chong 0.025 | Lukas 0.1 | Alex P 0.4
...
lambdaMet = 1;	%proportion of recErr and MetCost for reward function
