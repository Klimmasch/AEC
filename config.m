...
alpha_v = 0.4;                      %learning rate to update the value function | origin 0.05 | Lukas 1, 0.1 | Alex P 0.4
alpha_n = 0.4;                      %learning rate of natural policy gradient | origin 0.05 | Lukas 0.025 | Alex P 0.4
alpha_p = 0.4;                      %learning rate to update the policy function | origin 1 | Lukas 0.01 | Alex P 0.4
xi = 0.3;                           %discount factor | origin ? | Lukas 0.9 | Alex P 0.3
gamma = 0.01;                       %learning rate to update cumulative value | origin 1
Temperature = 1;                    %temperature in softmax function in policy network | origin 1
S0 = PARAMSC_L{3} + PARAMSC_S{3};   %number of neurons in the input layer (Small + Large scale)
weight_range = [0.4, 0.05];         %maximum initial weight | origin [0.4, 0.05]
...
PARAMModel = {learnedFile, textureFile, trainTime, sparseCodingType, interval};
