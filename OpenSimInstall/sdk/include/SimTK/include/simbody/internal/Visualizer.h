...
void drawFrameNow(const State& state, bool rendering) const;
/**@}**/
...
void initRenderer();
void rendererScene();
void setCameraTransformLeft(Transform left_X_GC);
void setCameraTransformRight(Transform right_X_GC);
void setImageLeft(std::string left_i);
void setImageRight(std::string right_i);
...
//void setCameraTransformRenderer(Transform& X_GC);
//fTransform X_GC;
//void Visualizer::rendererScene()
//{
//int argc = 1;
