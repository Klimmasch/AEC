...
need to compile the OpenEyeSimRendererV3, which is used to generate visual
...
In case the OpenEyeSim_.cc is modified, the OESRendererV3 needs to be recompiled
again. For that you execute:
